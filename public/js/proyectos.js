...
const PROYECTOS_DEFAULT = [
    {
        ...
        anyo: 2024,
        desc: 'Resideño de marca para una Inmobiliaria-Constructora. Logo, papelería, redes y web.',
        descCompleta: "InmoArquitectos es una inmobiliaria-Constructora con más de 15 años de experiencia en el sector. El principal objetivo de este proyecto e sdar sensación de seguridad y confianza a través de una imagen elegante y profesional, que refleje su expertise en el mercado inmobiliario. El logotipo combina un isotipo arquitectónico con una tipografía moderna y sólida, transmitiendo estabilidad y sofisticación. La paleta de colores se basa en el azul y el rojo, reforzando la sensación de familiaridad. El rediseño se aplicó a toda la papelería corporativa, redes sociales y sitio web, creando una presencia de marca coherente y atractiva.",
